			...
			<table id="servicos" class="table table-striped table-bordered table-hover">
			  <thead>
				<tr>
				  ...
				  <td class="text-left"><label><span data-toggle="tooltip" title="<?php echo $help_total; ?>"><?php echo $entry_total; ?></span></label></td>
			  ...
			  <tbody>
				...
				<tr id="servico-row<?php echo $servico_row; ?>">
				  ...
				  <td class="text-left"><input type="text" name="correios_servicos[<?php echo $servico_row; ?>][contrato_codigo]" value="<?php echo $servico_info['contrato_codigo']; ?>" class="form-control" /></td>
				  <td class="text-left"><input type="text" name="correios_servicos[<?php echo $servico_row; ?>][contrato_senha]" value="<?php echo $servico_info['contrato_senha']; ?>" class="form-control" /></td>
				  ...
				  <td class="text-left"><input type="text" name="correios_servicos[<?php echo $servico_row; ?>][total]" value="<?php echo $servico_info['total']; ?>" class="form-control" style="width:80px" /></td>
			  ...
			  <tfoot>
				<tr>
				  <td colspan="19" class="text-right"><button type="button" onclick="addServico();" data-toggle="tooltip" title="<?php echo $button_add_servico; ?>" class="btn btn-primary"><i class="fa fa-plus-circle"></i></button></td>
				</tr>
			  </tfoot>
			</table>
		  </div>
...
function addServico() {
	html  = '<tr id="servico-row' + servico_row + '">';
	  ...
	  html += '  <td class="text-left"><input type="text" name="correios_servicos[' + servico_row  + '][contrato_codigo]" value="" class="form-control" /></td>';
	  html += '  <td class="text-left"><input type="text" name="correios_servicos[' + servico_row  + '][contrato_senha]" value="" class="form-control" /></td>';
	  ...
	  html += '  <td class="text-left"><input type="text" name="correios_servicos[' + servico_row  + '][min_declarado]" value="18" class="form-control" style="width:80px" /></td>';
	  ...
	  html += '  <td class="text-left"><input type="text" name="correios_servicos[' + servico_row  + '][total]" value="" class="form-control" style="width:80px"/></td>';
