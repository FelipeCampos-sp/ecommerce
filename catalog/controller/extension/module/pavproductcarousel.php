...
class ControllerExtensionModulePavproductcarousel extends Controller {
	...
	public function index($setting) {
		...
		if (file_exists('catalog/view/theme/' . $config_theme . '/stylesheet/pavproductcarousel.css')) {
			$this->document->addStyle('catalog/view/theme/' . $config_theme . '/stylesheet/pavproductcarousel.css');
		} else {
		...
		if( isset($setting['tabs']['mostviewed']) ){
			...
			$this->data['heading_title'] = $this->language->get('Mais Visualizados');
		}
		if( isset($setting['tabs']['toprating']) ){
			...
			$this->data['heading_title'] = $this->language->get('Mais Comentados');
		}
