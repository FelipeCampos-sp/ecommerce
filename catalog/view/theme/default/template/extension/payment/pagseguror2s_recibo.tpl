...
<p>
	<img width="30" height="30" src="r2s/pagseguro/logo.png" style="float:left; margin: 0px 10px 5px 0px;" />
...
<br>
	- Metodo de pagamento:
	<span><?php echo ($meio)?$meio:tipoPagamento($dados['paymentMethod']['type']);?></span><?php if($dados['paymentMethod']['type']=='1'){?> em  <?php echo $dados['installmentCount'];?>x<?php } ?>
<br>
	- Status do pagamento:
...
<?php include("r2s/pagseguro/html.php");?>
