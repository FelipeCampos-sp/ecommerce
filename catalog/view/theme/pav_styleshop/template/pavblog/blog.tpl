				...
				<div id="blog-info" class="pav-blog wrapper blog-wrapper">
					...
					<div class="content">				
						<div class="blog-meta">	
							...
							<span class="created"><span><i class="fa fa-calendar"></i><?php echo $objlang->get("Postado no dia");?> <?php echo $blog['created'];?></span></span>
							<?php } ?>

							<?php if( $blog_show_hits ) { ?>
							<span class="hits">
								<span><i class="fa fa-insert-template"></i><?php echo $objlang->get("Visualizado");?></span>
						...
						<?php if( !empty($tags) ) { ?>
						<div class="blog-tags">
							<b><?php echo $objlang->get('Palavras Chave:');?></b>
						...
						<div class="blog-bottom row">
							...
							<div class="pavcol2">
								<h4><?php echo $objlang->get('Na mesma Categoria');?></h4>
								<ul>
						...
						<li><a href="<?php echo $objurl->link('pavblog/blog',"blog_id=".$item['blog_id']);?>"><?php echo $item['title'];?></a></li>
							...
							<div class="pavcol2">
								<h4><?php echo $objlang->get('Notícias Relacionadas');?></h4>
								<ul>
					...
					<?php if( $blog_show_comment_form ) { ?>
						...
						<?php }else { ?>
							...
							<h4><?php echo $objlang->get('Comentários'); ?></h4>
							<div class="pave-listcomments">
								...
								<div class="comment-item clearfix" id="comment<?php echo $comment['comment_id'];?>">
									...
									<div class="comment-wrap">
										...
										<span class="comment-created"><?php echo $objlang->get('Criado em');?> <span><?php echo $comment['created'];?></span></span>
										<span class="comment-postedby"><?php echo $objlang->get('Postado por');?> <span><?php echo $comment['user'];?></span></span>
										<span class="comment-link"><a href="<?php echo $link;?>#comment<?php echo $comment['comment_id'];?>"><?php echo $objlang->get('Comentários');?></a></span>
										</div>
							...
							<?php } ?>
							<h4><?php echo $objlang->get("Realizar Comentário");?></h4>
							<form action="<?php echo $comment_action;?>" method="post" id="comment-form" class="form-horizontal">
								<fieldset>
									
									<div class="message" style="display:none"></div>
									<div class="form-group required">
										<label class="col-sm-2 control-label" for="comment-user"><?php echo $objlang->get('Nome');?></label>
										<div class="col-sm-8">
									...
									<div class="form-group required">
										<label class="col-sm-2 control-label" for="comment-email"><?php echo $objlang->get('Email');?></label>
										<div class="col-sm-8">
									...
									<div class="form-group required">
										<label class="col-sm-2 control-label" for="comment-comment"><?php echo $objlang->get('Comentário');?></label>
										<div class="col-sm-8">
									...
									<div class="buttons-wrap right">
										<button class="btn btn-submit btn-theme-default" type="submit">
											<span><?php echo $objlang->get('Enviar');?></span>
										</button>
									</div>
								</fieldset>
							</form>
