...
<div class="product-info">
 ...
 <script type="text/javascript" src="<?php echo HTTPS_SERVER;?>catalog/view/javascript/simulador_frete.js"></script>
 <link rel="stylesheet" href="<?php echo HTTPS_SERVER;?>catalog/view/javascript/css_simulador.css" type="text/css" >	
 ...
 <input type="hidden" id="id_produto_frete" name="id_produto_frete" value="<?php echo $product_id; ?>">
